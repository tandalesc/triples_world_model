...
from twm.jepa.losses_v2 import (
    JEPALossV2,
    anneal_tau,
    prior_kl,
    sigreg_loss,
...
def test_token_ce_discriminative():
    ...
    Full leakage integrity (decoder memory = a* only) is tested by model_v2 tests
...
def test_sigreg_imported_from_v1():
    """sigreg_loss must be importable from losses_v2 (it re-exports from v1 losses.py)."""
    _seed()
