...
Run WITHOUT the concurrently-developed sibling modules (transition/decoder/losses_v2/
diagnostics_v2) by substituting minimal mocks that satisfy the FROZEN interfaces from
...
def _make_model(d_model=64, d_noun=32, n_slots=8, n_verbs=8, n_heads=4, use_pred=True):
    from twm.jepa.model_v2 import JEPAOperatorModelV2
