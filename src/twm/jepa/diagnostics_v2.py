...
v2 model interface expected by this module (from model_v2.py / design doc §11 Task C):
...
# Import v1 helpers — no reimplementation.
# Guard each import individually so the module is importable even if v1 diagnostics
# changes its internal structure (future-proofing for concurrent edits).
try:
...
from .losses_v2 import token_ce

if TYPE_CHECKING:
    pass  # model_v2.JEPAOperatorModelV2 — avoid circular import
